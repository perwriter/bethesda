    ...
    <div className="max-w-screen-lg mx-auto my-8 p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="border p-6 rounded-lg shadow-md bg-white text-center">
          <Image src="/paypal.png" alt="PayPal" width={128} height={128} className="mx-auto mb-4" />
          <h2 className="text-2xl font-semibold mb-4">Donate via PayPal</h2>
          <p className="mb-4">You can donate securely using PayPal. Click the button below to proceed:</p>
          <Link
        ...
        {/* I&M Bank Donation */}
        <div className="border p-6 rounded-lg shadow-md bg-white text-center">
          <Image src="/bank.png" alt="I&M Bank" width={128} height={128} className="mx-auto mb-4" />
